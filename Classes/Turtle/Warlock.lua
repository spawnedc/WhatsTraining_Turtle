...
ClassSpellsByLevel["Warlock"] = {
	...
	[6] = {
		...
		{id=695,name="Shadow Bolt",subText="Rank 2",level=6,icon="Interface\\Icons\\Spell_Shadow_ShadowBolt",requiredIds={686}}
	},
	[8] = {
	...
	[60] = {
		...
		{id=25307,name="Shadow Bolt",subText="Rank 10",level=60,icon="Interface\\Icons\\Spell_Shadow_ShadowBolt",requiredIds={11661}},
