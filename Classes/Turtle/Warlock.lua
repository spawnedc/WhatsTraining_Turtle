...
ClassSpellsByLevel["Warlock"] = {
	...
	[22] = {
		...
		{id=51692,name="Create Firestone",subText="",level=22,icon="Interface\\Icons\\INV_Ammo_FireTar",school="Demonology"}
	},
	[24] = {
	...
	[52] = {
		...
		{id=51695,name="Create Spellstone",subText="",level=52,icon="Interface\\Icons\\INV_Misc_Gem_Sapphire_01",school="Demonology"}
	},
	[54] = {
