...
ClassSpellsByLevel["Mage"] = {
	...
	[6] = {
		...
		{id=143,name="Fireball",subText="Rank 2",level=6,icon="Interface\\Icons\\Spell_Fire_FlameBolt",requiredIds={133}}
	},
	[8] = {
		{id=5143,name="Arcane Missiles",subText="Rank 1",level=8,icon="Interface\\Icons\\Spell_Nature_StarFall"},
		{id=205,name="Frostbolt",subText="Rank 2",level=8,icon="Interface\\Icons\\Spell_Frost_FrostBolt02",requiredIds={116}},
	...
	[54] = {
		...
		{id=10150,name="Fireball",subText="Rank 10",level=54,icon="Interface\\Icons\\Spell_Fire_FlameBolt",requiredIds={10149}},
	...
	[56] = {
		...
		{id=10181,name="Frostbolt",subText="Rank 10",level=56,icon="Interface\\Icons\\Spell_Frost_FrostBolt02",requiredIds={10180}}
	},
	[58] = {
